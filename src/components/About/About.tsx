...
export const About = () => {
  return (
    <div {...classes()}>
      <h1 {...classes("title")}>What the CZEDD is?</h1>
      <p>
      ...
      <h1 {...classes("title")}>Who is the CZEDD for?</h1>
      <p>
      ...
      <h1 {...classes("title")}>How to use the CZEDD?</h1>
      <p>
      ...
      <h1 {...classes("title")}>Why to use the CZEDD?</h1>
      <p>
